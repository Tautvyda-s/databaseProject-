...
class services {
	...
	public function __construct() {
		...
		$this->ligu_tipu_lentele = config::DB_PREFIX . 'ligos_tipas';
	}
	
	public function getLiguTipuList($limit = null, $offset = null) {
		$limitOffsetString = "";
		if(isset($limit)) {
		...
		$query = "  SELECT *
					FROM `{$this->ligu_tipu_lentele}`" . $limitOffsetString;
